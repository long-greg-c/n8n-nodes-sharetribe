...
export async function close(this: IExecuteFunctions, index: number): Promise<INodeExecutionData[]> {
	...
	return executeSharetribeRequest(this, HTTP_METHODS.POST, ENDPOINTS.LISTINGS_CLOSE, body, qs);
}
